###
# Makes the hi-temp systematics check for templates
###
...
a=np.genfromtxt(f'{temp_selections}T4400-5100.csv').astype(int).astype(str)
   ...
   if file ==[]:
      print('no slit-loss corrected=', a[i])
       ...
       shutil.copyfile(file[0],
                       f'{xshooter_dir}all_dr2_fits_G789K012_hi_var/{file[0]}')
