...
'''
#libary directory
libary_dir_xshooter = '/data/raw_data/KECK_KCWI_SLACS_kinematics_shawn/xshooter_lib/' 
			#/Users/Geoff/anaconda3/envs/py39/lib/python3.9/site' \
                      #'-packages/ppxf/all_dr2_fits_G789K012/'
#data directory
dir = '/data/raw_data/KECK_KCWI_SLACS_kinematics_shawn/ {kcwi data cube directory} '
...
FWHM_tem_xshooter = {where does this come from?} #0.43
