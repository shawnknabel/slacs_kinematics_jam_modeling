...
07/12/22 - Center spectrum aperture R=1
'''
...
# make save directory
save_dir = f'{dir}{obj_name}_kinematics_{cen_R}/'
...
spectrum_aperture = f'{dir}{obj_abbr}_central_spectrum_{cen_R}.fits' 
...
np.savetxt(save_dir + obj_name + 'systematics_VD.txt', systematics_VD, delimiter=',')
np.savetxt(save_dir + obj_name + 'systematics_dVD.txt', systematics_dVD, delimiter=',')
np.savetxt(save_dir + obj_name + 'systematics_V.txt', systematics_V, delimiter=',')
np.savetxt(save_dir + obj_name + 'systematics_dV.txt', systematics_VD, delimiter=',')
