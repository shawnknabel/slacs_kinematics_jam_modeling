...
for obj_name in obj_names:
    ...
    save_dir = f'{dir}{obj_name}_final_kinematics_template_subsets_310822/'
    
    VD_2d, dVD_2d, V_2d, dV_2d = kinematics_map_systematics(save_dir, obj_name, mosaic_name, radius_in_pixels)
    ...
    plt.savefig(save_dir + obj_name + '_VD_map.pdf')
    plt.pause(1)
    plt.clf()
    ...
    plt.title(f"{obj_name} velocity dispersion error")
    plt.xticks(ticks_pix, labels=ticklabels)
    plt.yticks(ticks_pix, labels=ticklabels)
    plt.xlabel('arcsec')
    plt.ylabel('arcsec')
    plt.savefig(save_dir + obj_name + '_dVD_map.png')
    plt.savefig(save_dir + obj_name + '_dVD_map.pdf')
    ...
    plt.xlabel('arcsec')
    plt.ylabel('arcsec')
    plt.savefig(save_dir + obj_name + '_V_map.png')
    plt.savefig(save_dir + obj_name + '_V_map.pdf')
    plt.pause(1)
    plt.clf()
    ...
    plt.title(f"{obj_name} velocity error")
    plt.xticks(ticks_pix, labels=ticklabels)
    plt.yticks(ticks_pix, labels=ticklabels)
    plt.xlabel('arcsec')
    plt.ylabel('arcsec')
    plt.savefig(save_dir + obj_name + '_dV_map.png')
    plt.savefig(save_dir + obj_name + '_dV_map.pdf')
    plt.pause(1)
    plt.clf()
