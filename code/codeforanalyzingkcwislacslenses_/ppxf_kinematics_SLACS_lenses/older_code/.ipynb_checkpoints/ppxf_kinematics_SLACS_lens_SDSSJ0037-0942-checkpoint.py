...
'''
#libary directory
libary_dir_xshooter = '/data/raw_data/KECK_KCWI_SLACS_kinematics_shawn/' \
                        'xshooter_lib/all_dr2_fits_G789K012' 
			#/Users/Geoff/anaconda3/envs/py39/lib/python3.9/site' \
                      #'-packages/ppxf/all_dr2_fits_G789K012/'
    
#data directorysingle sudo linux
dir = f'/data/raw_data/KECK_KCWI_SLACS_kinematics_shawn/CF_mosaics/{obj_name}/' # wait what is this drizzle file?

	#		"/Volumes/Seagate/drizzlepac_test/drizzle_file_KCWI_J1630/"

#KCWI mosaic datacube
name = f'KCWI_{obj_abbr}_icubes_mosaic_0.1457'
			#"KCWI_J1630_icubes_mosaic_0.1457"

#spectrum from the lens center
spectrum_aperture = f'{dir}{obj_abbr}_galaxy.fits' 
...
dir_temperture = '/local/shawnknabel/slacs_kinematics/code/codeforanalyzingkcwislacslenses_/t_eff.xlsx'
		#'/Users/Geoff/anaconda3/envs/py39/lib/python3.9/site' \
...
'''
Step 7: plot the kinematics measurements and save 2d maps
'''
VD_2d, dVD_2d, V_2d, dV_2d = kinematics_map(dir, name, radius_in_pixels)

np.savetxt(dir + obj_name + '_VD_2d.txt', VD_2d, delimiter=',')
np.savetxt(dir + obj_name + '_dVD_2d.txt', dVD_2d, delimiter=',')
np.savetxt(dir + obj_name + '_V_2d.txt', V_2d, delimiter=',')
np.savetxt(dir + obj_name + '_dV_2d.txt', dV_2d, delimiter=',')
