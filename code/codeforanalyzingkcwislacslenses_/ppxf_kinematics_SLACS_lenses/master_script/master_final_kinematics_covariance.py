...
for obj_name in obj_names:
    ...
    cov_error = open(f'{err_dir}error_logs.txt', 'w')
    cov_error.write('########################################## \n')
    cov_error.write('########################################## \n')
    ...
    for vorbin_SN_target in vorbin_SN_targets:
        ...
        for g_band in g_bands:
            ...
            VD = np.genfromtxt(f'{syst_g_dir}{obj_name}_{g_band}_systematics_VD.txt', delimiter=',')
            dV = np.genfromtxt(f'{syst_g_dir}{obj_name}_{g_band}_systematics_dV.txt', delimiter=',')
            dVD = np.genfromtxt(f'{syst_g_dir}{obj_name}_{g_band}_systematics_dVD.txt', delimiter=',')
            chi2 = np.genfromtxt(f'{syst_g_dir}{obj_name}_{g_band}_systematics_chi2.txt', delimiter=',')
            ...
            print('####################################')
            print()
            print(f'{obj_name} {g_band} finished.')
            print()
