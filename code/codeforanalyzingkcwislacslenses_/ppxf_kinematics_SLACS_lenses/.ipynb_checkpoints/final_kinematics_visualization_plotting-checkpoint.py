...
def kinematics_map_systematics(dir, name, mosaic_name, radius_in_pixels):
    '''
...
for obj_name in obj_names:
    ...
    VD_2d, dVD_2d, V_2d, dV_2d = kinematics_map_systematics(dir, obj_name, mosaic_name, radius_in_pixels)
