...
def calc_1d_kinematics (obj_name, slit_width=0.5):
    ...
    plt.xlabel(r'R (arcsec)',fontsize=14)
    plt.ylabel(r'$\sigma$ (km/s)',fontsize=14)
    plt.savefig(f'{save_dir}{obj_name}_1d_VD_profile.png')
    plt.savefig(f'{save_dir}{obj_name}_1d_VD_profile.pdf')
    plt.show()
    ...
    plt.savefig(f'{save_dir}{obj_name}_kinematic_pa_fit.png')
    plt.savefig(f'{save_dir}{obj_name}_kinematic_pa_fit.pdf')
    ...
    # plot
    plt.figure(figsize=(12,4))
    plt.errorbar(xx_means_slit, V_slit, 
                 xerr=(xx_means_slit-xx_mins_slit,xx_maxs_slit-xx_means_slit),
                 yerr=dV_slit,
                 c='k',
                 marker='o', 
    ...
    plt.savefig(f'{save_dir}{obj_name}_1d_V_profile.png')
    plt.savefig(f'{save_dir}{obj_name}_1d_VD_profile.pdf')
    plt.show()
...
for obj_name in obj_names:
    ...
    print('#########################################################')
    print()
    print(f'Calculating 1-D kinematics of {obj_name}')
    print()
    calc_1d_kinematics (obj_name, slit_width)
    print()
