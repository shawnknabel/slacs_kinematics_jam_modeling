...
fig, axs = plt.subplot_mosaic(axes,gridspec_kw={"hspace":-0.55,
                                               "wspace":0.0},
                             figsize=((12,12)))
...
plt.savefig(f'{data_dir}mosaics/slacs_kcwi_kinmaps.png')
plt.savefig(f'{data_dir}mosaics/slacs_kcwi_kinmaps.pdf')
