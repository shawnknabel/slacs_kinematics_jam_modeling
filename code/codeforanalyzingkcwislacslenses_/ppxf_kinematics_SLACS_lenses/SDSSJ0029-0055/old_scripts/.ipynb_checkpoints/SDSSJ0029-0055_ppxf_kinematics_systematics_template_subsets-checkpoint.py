...
09/07/22 - redoing template subsets and adding random subsets of the full Xshooter lib.
...
libraries = ['all_dr2_fits_G789K012_rand_subset_1',
             ...
             'all_dr2_fits_rand_subset_1',
             'all_dr2_fits_rand_subset_2',
             'all_dr2_fits_rand_subset_3']
...
global_fit_chi2_log = pd.DataFrame((np.zeros((3**3*6,2))), dtype=object, columns=['model_name','chi2'])
n = 0
