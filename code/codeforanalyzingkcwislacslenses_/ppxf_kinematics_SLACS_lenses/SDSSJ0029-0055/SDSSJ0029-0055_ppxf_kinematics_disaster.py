...
T_exp = 1800*5#*60 #266 * 60 # exposure time in seconds... this is where I made the disastrous mistake
...
# object directory
dir = f'{data_dir}mosaics/{obj_name}/{obj_name}_disaster/'

# make save directory
save_dir = dir#f'{dir}{obj_name}_kinematics_disaster/'
...
plt.savefig(dir + obj_name + '_voronoi_binning.pdf') # 09/07/22 added this line to save for the paper
plt.pause(1)
plt.clf()
