...
'''
Step 2.5: remove background source (specific to J1112)
'''
# check it first
...
for vorbin_SN_target in vorbin_SN_targets:
    ...
    get_voronoi_binning_data(mos_dir, target_dir, mos_name, obj_name, nobs_name=nobs_name) # pulls cropped nobs datacube from the mosaic directory and voronoi info from kinematic directory # kcwi_util adjusted to take nobs_crop if it exists
