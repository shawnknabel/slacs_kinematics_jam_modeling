...
for obj_name in obj_names:
    ...
    ################
    ####### 09/15/22 - NEW! Trying to subtract the global template velocities from each bin velocity (row)
    ...
    for vel_moment in ['VD','V','Vrms']: ### ignore the velocities for now
        ...
        if is_pos_semidef(covariance_matrix) != True:
            ...
            assert(is_pos_semidef(covariance_matrix)) , "covariance matrix still not positive semi-definite, take a closer look"
