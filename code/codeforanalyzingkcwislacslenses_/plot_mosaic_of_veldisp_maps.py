...
for i in range(len(obj_names)):
    ...
    cbar.ax.tick_params(rotation=0, labelsize='small', pad=0.0, direction ='in')
    axs[letter].set_xticks(ticks_pix, ticklabels, fontsize=10)
    axs[letter].set_yticks(ticks_pix, ticklabels, fontsize=10)
    ...
    axs[letter].text(5,39,obj_name,fontsize=10)
...
plt.savefig(f'{data_dir}mosaics/mosaic_of_veldisp.png')
plt.savefig(f'{data_dir}mosaics/mosaic_of_veldisp.pdf')
