'''
03/11/24 - Shawn Knabel
This script will run the latest versions of space_jam.py on slacs lenses for the axisymmetric spherical and cylindrical models.
'''
...
def task_1(i):
    ...
    geometry='axi'
    align='sph'
    # 03/21/24 - adding the spherical mass model keyword
    spherical_mass=True
    ...
    date_time = '2024_03_21'#datetime.now().strftime("%Y_%m_%d")#-%I_%M_%S_%p"
    run_id = 1
    ...
    welcome_to_the_jam = space_jam(jam_dir, jam_details_file,
                                   ...
                                   lensprior=lensprior, fix_pars=fix_pars, lambda_int=lambda_int,
                                   minimization=minimization, sampler_args=sampler_args, date_time=date_time, 
                                   run_id=run_id, plot=True, overwrite=True, 
                                   test_prior=False, constant_err=False, kinmap_test=None,
                                  spherical_mass=spherical_mass)
...
def task_2(i):
    ...
    welcome_to_the_jam = space_jam(jam_dir, jam_details_file,
                                   ...
                                   minimization=minimization, sampler_args=sampler_args, date_time=date_time, 
                                   run_id=run_id, plot=True, overwrite=True, 
                                   test_prior=False, constant_err=False, kinmap_test=None, spherical_mass=spherical_mass)
