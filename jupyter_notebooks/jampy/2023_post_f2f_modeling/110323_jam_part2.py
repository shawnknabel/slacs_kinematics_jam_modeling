...
def jam_bestfit (pars, **kwargs):
    ...
    if geometry=='axi':
        ...
        surf_pot, sigma_pot, qobs_pot = total_mass_mge(surf_lum, sigma_lum, qobs_lum, qobs_eff,
...
def total_mass_mge (surf_lum, sigma_lum, qobs_lum, qobs_eff,
    ...
    if model == 'nfw':
        ...
        surf_pot, sigma_pot, qobs_pot = power_law_mge(gamma, theta_E, qobs_eff, rbreak, lambda_int, rs_mst, zlens, zsource, plot)
        #plt.pause(1)
...
bounds_pow_const = [[1.4, 0.051, 0.0, 0.7, 0.75], 
...
bounds_pow_om = [[1.4, 0.051, 0.1, 0.7, 0.75],  
                ...
                for w, geometry in enumerate(geoms):
                    ...
                    for m, align in enumerate(aligns):
                        ...
                        for n, lensprior in enumerate(lenspriors):
                            ...
                            space_jam (obj_name, SN, model, anisotropy, geometry, align,                                         sampler='emcee', sampler_args=sampler_args,                                        rs_mst=rs_mst,                                        p0=p0, bounds=bounds, sigpar=sigpar, prior_type=prior_type, lensprior=lensprior,                                        date_time=date_time, overwrite=True, run_id=1, test_prior=False)
