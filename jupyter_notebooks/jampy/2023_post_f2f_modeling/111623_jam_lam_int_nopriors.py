                ...
                for w, geometry in enumerate(geoms):
                    ...
                    for m, align in enumerate(aligns):
                        ...
                        for n, lensprior in enumerate([lenspriors[1]]):
                            ...
                            space_jam (obj_name, SN, model, anisotropy, geometry, align,                                         sampler='emcee', sampler_args=sampler_args,                                        rs_mst=None,                                        p0=p0, bounds=bounds, sigpar=sigpar, prior_type=prior_type, lensprior=lensprior,                                        date_time=date_time, overwrite=True, run_id=1, test_prior=False)#True)
