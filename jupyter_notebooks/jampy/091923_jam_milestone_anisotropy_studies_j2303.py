...
active_obj_names =  np.array([
                            #'SDSSJ1630+4520',
                             'SDSSJ2303+1422'
                                ])
#obj_names.copy() # np.array(obj_names)[active_obj]
...
# skip the first four models when constant anisotropy ( only OM needs to be redone)
skip_models = np.array([], int)#np.array([0,1,2,3])
#any(skip_models == 0)
